      ...
      <div className="bg-white rounded-[32px] border border-gray-100/50 shadow-sm p-8 space-y-10">
        ...
        <div>
          ...
          <div className="flex flex-col gap-1.5 relative">
            <button className="flex items-center justify-between px-4 py-3 rounded-xl text-sm font-semibold transition-all group bg-primary/5 text-primary">
              <div className="flex items-center gap-3">
                <div className="w-1.5 h-1.5 rounded-full transition-all bg-primary scale-125"></div>
            ...
            {categories.map(({ id, name }) => (
              <div key={id} className="relative group/parent">
                <button className="w-full flex items-center justify-between px-4 py-3 rounded-xl text-sm font-semibold transition-all group text-slate-500 hover:bg-gray-50 hover:text-slate-900">
                  <div className="flex items-center gap-3">
                    <div className="w-1.5 h-1.5 rounded-full transition-all bg-transparent group-hover:bg-gray-300"></div>
                    <span>{name}</span>
                  </div>
                </button>
              </div>

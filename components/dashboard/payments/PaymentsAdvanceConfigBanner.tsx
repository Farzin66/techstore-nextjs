...
const PaymentsAdvanceConfigBanner = () => {
  return (
    <div className="w-full items-center rounded-3xl flex justify-between gap-4 mt-6 mb-10 border border-gray-100 bg-gray-100 p-6 shadow-sm">
        <div className="flex h-14 w-14 mb-4 items-center justify-center rounded-[1.5rem] border border-blue-100 bg-white text-primary/60 shadow-sm transition-transform duration-500">

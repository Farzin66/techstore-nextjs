  ...
  return (
    <div className="relative mb-6 overflow-hidden rounded-3xl border border-gray-100 bg-white px-6 py-8 shadow-sm sm:px-8 sm:py-10">
      ...
      <div className="flex flex-col">
        ...
        <textarea rows={6} className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all font-bold text-sm" placeholder="Modern E-commerce Platform"></textarea>
      </div>
    </div>
  )
}

...
import type { DashboardUser } from "@/app/services/userService";
                  ...
                  <td className="px-5 py-5 sm:px-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <div
                          className={`mt-1 inline-flex items-center gap-1 rounded-md border px-1.5 py-0.5 text-[8px] font-black uppercase tracking-wider ${

        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4">
            {
                categories.map(({name, icon: Icon, id})=>{
                    return(   
                      <button key={id} className="group p-4 rounded-lg transition-all border flex flex-col items-center gap-3 bg-white text-gray-400 border-gray-100 hover:border-primary/50 hover:shadow-sm">

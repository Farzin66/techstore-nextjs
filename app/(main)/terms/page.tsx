            ...
            <div className="container-custom relative">
                <div className="max-w-3xl mx-auto text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    ...
                    <h1 className="text-5xl sm:text-7xl font-black text-foreground tracking-tight leading-[1.1]">
                        Platform{" "}
                        <span className="text-primary italic">Rules.</span>
                    </h1>
                    <p className="text-xl text-gray-500 font-medium leading-relaxed max-w-2xl mx-auto">Clear, transparent, and fair. Our terms are designed to protect both the community and the creators behind Tech-Store.</p>
                            ...
                            <TermsSection key={section.id} section={section}>
                                {section.id === 1 &&(
                                    <div className="space-y-8">
                                        <p className="text-lg text-gray-600 leading-relaxed font-medium">When accessing Tech-Store, you enter a commitment of mutual respect and high-performance collaboration.</p>
                                        <div className="grid sm:grid-cols-2 gap-10">
                                            {
                                                termsUserProtocol.map((item) =>(
                                                    <div key={item.id} className="space-y-2">
                                                        ...
                                                        <p className="text-sm text-gray-500 font-medium leading-relaxed pl-4 border-l border-blue-100">{item.description}</p>
                                                    </div>
                                                ))
                                            }
                                        </div>
                                ...
                                {section.id === 2 &&(
                                    <div className="grid sm:grid-cols-2 gap-12 items-center">
                                        <div className="space-y-6">
                                            <p className="text-lg text-gray-600 leading-relaxed font-medium">Every order is a secure handshake. Prices are precise, and transactions are vaulted through Stripe for total financial security.</p>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-[2rem] border border-gray-100 space-y-4">
                                            <p className="text-sm text-gray-500 leading-relaxed font-medium italic">"If we detect inaccuracies in pricing or stock availability during order ingestion, we reserve the right to nullify the transaction and issue an immediate correction."</p>
                                        </div>
                                    </div>
                                )}
                                {section.id === 3 &&(
                                        ...
                                        <div className="grid sm:grid-cols-3 gap-6 text-center">
                                            {
                                                termsSiteGuardrails.map((item)=>(
                                                    <div key={item.id} className="p-4 rounded-2xl bg-white border border-gray-100 shadow-sm">

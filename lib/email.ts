    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px; border: 1px solid #eee; border-radius: 20px;">
        <h1 style="text-align: center; color: #0f172a;">
          TECH <span style="color: #10b981;">STORE</span>
        </h1>
        ...
        <div style="background: #f8fafc; padding: 25px; text-align: center; border-radius: 15px; margin: 30px 0;">
          <span style="font-family: monospace; font-size: 40px; font-weight: bold; color: #10b981; letter-spacing: 8px;">
            ${otp}
          </span>
        </div>
